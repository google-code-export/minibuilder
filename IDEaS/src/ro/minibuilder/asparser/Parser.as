...
package ro.minibuilder.asparser
{
	...
	public class Parser implements IThread
	{
		...
		public function updateFormating(font:Font,fontSize:int = 12, bgColor:uint = 0xffffff):void{
			//syntax highlighting
			
			formats.setValue('default', new TextFormat(font.fontName, fontSize, bgColor == 0 ? 0x8c8c8c : 0x111111, false, false));
			formats.setValue(Token.KEYWORD, new TextFormat(font.fontName, fontSize, 0x1039FF, false, false));
			formats.setValue(Token.KEYWORD2, new TextFormat(font.fontName, fontSize, 0x247ECE, false, false));
			formats.setValue(Token.E4X, new TextFormat(font.fontName, fontSize, 0x613BB9, false, false));
			formats.setValue(Token.COMMENT, new TextFormat(font.fontName, fontSize, 0x109900, false, true));
			formats.setValue(Token.REGEXP, new TextFormat(font.fontName, fontSize, 0xa3a020, false, false));
			formats.setValue(Token.STRING, new TextFormat(font.fontName, fontSize, 0xB30000, false, false));
			formats.setValue('topType', new TextFormat(font.fontName, fontSize, 0x981056, false, false));
		 ...
		 */
		public function applyFormats(textField:TextField):void
		{
