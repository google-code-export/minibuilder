...
public class JNotify
{
	...
	private static IJNotify _instance = null;
	...
	static 
	{
		...
		if (osName.startsWith("windows") && System.getProperty("sun.arch.data.model") != "64")
		{
			try
			{
